...
func (m OrderCancelReplaceRequest) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m OrderCancelReplaceRequest) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m OrderCancelReplaceRequest) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) HasOptPayAmount() bool {
...
func (m OrderCancelReplaceRequest) HasFuturesValuationMethod() bool {

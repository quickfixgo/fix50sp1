...
func (m AllocationInstructionAlert) SetAvgPx(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetSecurityIDSource(v enum.SecurityIDSource) {
...
func (m AllocationInstructionAlert) SetQuantity(value decimal.Decimal, scale int32) {
	m.Set(field.NewQuantity(value, scale))
}

//SetSide sets Side, Tag 54
func (m AllocationInstructionAlert) SetSide(v enum.Side) {
...
func (m AllocationInstructionAlert) SetSettlType(v enum.SettlType) {
...
func (m AllocationInstructionAlert) SetSymbolSfx(v enum.SymbolSfx) {
...
func (m AllocationInstructionAlert) SetAllocTransType(v enum.AllocTransType) {
...
func (m AllocationInstructionAlert) SetPositionEffect(v enum.PositionEffect) {
...
func (m AllocationInstructionAlert) SetNetMoney(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetAccruedInterestRate(value decimal.Decimal, scale int32) {
	m.Set(field.NewAccruedInterestRate(value, scale))
}

//SetAccruedInterestAmt sets AccruedInterestAmt, Tag 159
func (m AllocationInstructionAlert) SetAccruedInterestAmt(value decimal.Decimal, scale int32) {
	m.Set(field.NewAccruedInterestAmt(value, scale))
}

//SetSecurityType sets SecurityType, Tag 167
func (m AllocationInstructionAlert) SetSecurityType(v enum.SecurityType) {
...
func (m AllocationInstructionAlert) SetAllocLinkType(v enum.AllocLinkType) {
...
func (m AllocationInstructionAlert) SetPutOrCall(v enum.PutOrCall) {
	m.Set(field.NewPutOrCall(v))
}

//SetStrikePrice sets StrikePrice, Tag 202
func (m AllocationInstructionAlert) SetStrikePrice(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetSpread(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetBenchmarkCurveName(v enum.BenchmarkCurveName) {
...
func (m AllocationInstructionAlert) SetCouponRate(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetRepurchaseRate(value decimal.Decimal, scale int32) {
	m.Set(field.NewRepurchaseRate(value, scale))
}

//SetFactor sets Factor, Tag 228
func (m AllocationInstructionAlert) SetFactor(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetContractMultiplier(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetYieldType(v enum.YieldType) {
	m.Set(field.NewYieldType(v))
}

//SetYield sets Yield, Tag 236
func (m AllocationInstructionAlert) SetYield(value decimal.Decimal, scale int32) {
	m.Set(field.NewYield(value, scale))
}

//SetTotalTakedown sets TotalTakedown, Tag 237
func (m AllocationInstructionAlert) SetTotalTakedown(value decimal.Decimal, scale int32) {
	m.Set(field.NewTotalTakedown(value, scale))
}

//SetConcession sets Concession, Tag 238
func (m AllocationInstructionAlert) SetConcession(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetTradingSessionID(v enum.TradingSessionID) {
...
func (m AllocationInstructionAlert) SetGrossTradeAmt(value decimal.Decimal, scale int32) {
	m.Set(field.NewGrossTradeAmt(value, scale))
}

//SetPriceType sets PriceType, Tag 423
func (m AllocationInstructionAlert) SetPriceType(v enum.PriceType) {
	m.Set(field.NewPriceType(v))
}

//SetMultiLegReportingType sets MultiLegReportingType, Tag 442
func (m AllocationInstructionAlert) SetMultiLegReportingType(v enum.MultiLegReportingType) {
...
func (m AllocationInstructionAlert) SetProduct(v enum.Product) {
...
func (m AllocationInstructionAlert) SetTotalAccruedInterestAmt(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetInstrRegistry(v enum.InstrRegistry) {
...
func (m AllocationInstructionAlert) SetMatchType(v enum.MatchType) {
...
func (m AllocationInstructionAlert) SetCustOrderCapacity(v enum.CustOrderCapacity) {
	m.Set(field.NewCustOrderCapacity(v))
}

//SetTradingSessionSubID sets TradingSessionSubID, Tag 625
func (m AllocationInstructionAlert) SetTradingSessionSubID(v enum.TradingSessionSubID) {
	m.Set(field.NewTradingSessionSubID(v))
}

//SetAllocType sets AllocType, Tag 626
func (m AllocationInstructionAlert) SetAllocType(v enum.AllocType) {
...
func (m AllocationInstructionAlert) SetBenchmarkPrice(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetDeliveryForm(v enum.DeliveryForm) {
...
func (m AllocationInstructionAlert) SetYieldRedemptionPrice(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetInterestAtMaturity(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetBookingType(v enum.BookingType) {
	m.Set(field.NewBookingType(v))
}

//SetTerminationType sets TerminationType, Tag 788
func (m AllocationInstructionAlert) SetTerminationType(v enum.TerminationType) {
...
func (m AllocationInstructionAlert) SetAllocCancReplaceReason(v enum.AllocCancReplaceReason) {
	m.Set(field.NewAllocCancReplaceReason(v))
}

//SetAllocIntermedReqType sets AllocIntermedReqType, Tag 808
func (m AllocationInstructionAlert) SetAllocIntermedReqType(v enum.AllocIntermedReqType) {
	m.Set(field.NewAllocIntermedReqType(v))
}

//SetAvgPxIndicator sets AvgPxIndicator, Tag 819
func (m AllocationInstructionAlert) SetAvgPxIndicator(v enum.AvgPxIndicator) {
	m.Set(field.NewAvgPxIndicator(v))
}

//SetTrdType sets TrdType, Tag 828
func (m AllocationInstructionAlert) SetTrdType(v enum.TrdType) {
	m.Set(field.NewTrdType(v))
}

//SetTrdSubType sets TrdSubType, Tag 829
func (m AllocationInstructionAlert) SetTrdSubType(v enum.TrdSubType) {
	m.Set(field.NewTrdSubType(v))
}

//SetQtyType sets QtyType, Tag 854
func (m AllocationInstructionAlert) SetQtyType(v enum.QtyType) {
	m.Set(field.NewQtyType(v))
}

//SetAllocNoOrdersType sets AllocNoOrdersType, Tag 857
func (m AllocationInstructionAlert) SetAllocNoOrdersType(v enum.AllocNoOrdersType) {
	m.Set(field.NewAllocNoOrdersType(v))
}

//SetAvgParPx sets AvgParPx, Tag 860
func (m AllocationInstructionAlert) SetAvgParPx(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetPctAtRisk(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetCPProgram(v enum.CPProgram) {
...
func (m AllocationInstructionAlert) SetMarginRatio(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetDeliveryType(v enum.DeliveryType) {
	m.Set(field.NewDeliveryType(v))
}

//SetEndAccruedInterestAmt sets EndAccruedInterestAmt, Tag 920
func (m AllocationInstructionAlert) SetEndAccruedInterestAmt(value decimal.Decimal, scale int32) {
	m.Set(field.NewEndAccruedInterestAmt(value, scale))
}

//SetStartCash sets StartCash, Tag 921
func (m AllocationInstructionAlert) SetStartCash(value decimal.Decimal, scale int32) {
	m.Set(field.NewStartCash(value, scale))
}

//SetEndCash sets EndCash, Tag 922
func (m AllocationInstructionAlert) SetEndCash(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetSecurityStatus(v enum.SecurityStatus) {
...
func (m AllocationInstructionAlert) SetStrikeMultiplier(value decimal.Decimal, scale int32) {
	m.Set(field.NewStrikeMultiplier(value, scale))
}

//SetStrikeValue sets StrikeValue, Tag 968
func (m AllocationInstructionAlert) SetStrikeValue(value decimal.Decimal, scale int32) {
	m.Set(field.NewStrikeValue(value, scale))
}

//SetMinPriceIncrement sets MinPriceIncrement, Tag 969
func (m AllocationInstructionAlert) SetMinPriceIncrement(value decimal.Decimal, scale int32) {
...
func (m AllocationInstructionAlert) SetRndPx(value decimal.Decimal, scale int32) {
	m.Set(field.NewRndPx(value, scale))
}

//SetUnitOfMeasure sets UnitOfMeasure, Tag 996
func (m AllocationInstructionAlert) SetUnitOfMeasure(v enum.UnitOfMeasure) {
	m.Set(field.NewUnitOfMeasure(v))
}

//SetTimeUnit sets TimeUnit, Tag 997
func (m AllocationInstructionAlert) SetTimeUnit(v enum.TimeUnit) {
...
func (m AllocationInstructionAlert) SetMinPriceIncrementAmount(value decimal.Decimal, scale int32) {
	m.Set(field.NewMinPriceIncrementAmount(value, scale))
}

//SetUnitOfMeasureQty sets UnitOfMeasureQty, Tag 1147
func (m AllocationInstructionAlert) SetUnitOfMeasureQty(value decimal.Decimal, scale int32) {
	m.Set(field.NewUnitOfMeasureQty(value, scale))
}

//SetSecurityGroup sets SecurityGroup, Tag 1151
func (m AllocationInstructionAlert) SetSecurityGroup(v string) {
	m.Set(field.NewSecurityGroup(v))
}

//SetSecurityXMLLen sets SecurityXMLLen, Tag 1184
func (m AllocationInstructionAlert) SetSecurityXMLLen(v int) {
	m.Set(field.NewSecurityXMLLen(v))
}

//SetSecurityXML sets SecurityXML, Tag 1185
func (m AllocationInstructionAlert) SetSecurityXML(v string) {
	m.Set(field.NewSecurityXML(v))
}

//SetSecurityXMLSchema sets SecurityXMLSchema, Tag 1186
func (m AllocationInstructionAlert) SetSecurityXMLSchema(v string) {
	m.Set(field.NewSecurityXMLSchema(v))
}

//SetPriceUnitOfMeasure sets PriceUnitOfMeasure, Tag 1191
func (m AllocationInstructionAlert) SetPriceUnitOfMeasure(v string) {
	m.Set(field.NewPriceUnitOfMeasure(v))
}

//SetPriceUnitOfMeasureQty sets PriceUnitOfMeasureQty, Tag 1192
func (m AllocationInstructionAlert) SetPriceUnitOfMeasureQty(value decimal.Decimal, scale int32) {
	m.Set(field.NewPriceUnitOfMeasureQty(value, scale))
}

//SetSettlMethod sets SettlMethod, Tag 1193
func (m AllocationInstructionAlert) SetSettlMethod(v enum.SettlMethod) {
	m.Set(field.NewSettlMethod(v))
}

//SetExerciseStyle sets ExerciseStyle, Tag 1194
func (m AllocationInstructionAlert) SetExerciseStyle(v enum.ExerciseStyle) {
	m.Set(field.NewExerciseStyle(v))
}

//SetOptPayAmount sets OptPayAmount, Tag 1195
func (m AllocationInstructionAlert) SetOptPayAmount(value decimal.Decimal, scale int32) {
	m.Set(field.NewOptPayAmount(value, scale))
}

//SetPriceQuoteMethod sets PriceQuoteMethod, Tag 1196
func (m AllocationInstructionAlert) SetPriceQuoteMethod(v enum.PriceQuoteMethod) {
	m.Set(field.NewPriceQuoteMethod(v))
}

//SetFuturesValuationMethod sets FuturesValuationMethod, Tag 1197
func (m AllocationInstructionAlert) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
	m.Set(field.NewFuturesValuationMethod(v))
}

//SetListMethod sets ListMethod, Tag 1198
func (m AllocationInstructionAlert) SetListMethod(v enum.ListMethod) {
	m.Set(field.NewListMethod(v))
}

//SetCapPrice sets CapPrice, Tag 1199
func (m AllocationInstructionAlert) SetCapPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewCapPrice(value, scale))
}

//SetFloorPrice sets FloorPrice, Tag 1200
func (m AllocationInstructionAlert) SetFloorPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewFloorPrice(value, scale))
}

//SetProductComplex sets ProductComplex, Tag 1227
func (m AllocationInstructionAlert) SetProductComplex(v string) {
	m.Set(field.NewProductComplex(v))
}

//SetFlexProductEligibilityIndicator sets FlexProductEligibilityIndicator, Tag 1242
func (m AllocationInstructionAlert) SetFlexProductEligibilityIndicator(v bool) {
	m.Set(field.NewFlexProductEligibilityIndicator(v))
}

//SetFlexibleIndicator sets FlexibleIndicator, Tag 1244
func (m AllocationInstructionAlert) SetFlexibleIndicator(v bool) {
	m.Set(field.NewFlexibleIndicator(v))
}

//GetAvgPx gets AvgPx, Tag 6
func (m AllocationInstructionAlert) GetAvgPx() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityIDSource() (v enum.SecurityIDSource, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetLastMkt() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetQuantity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSide() (v enum.Side, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSymbol() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTransactTime() (v time.Time, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSettlType() (v enum.SettlType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSettlDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSymbolSfx() (v enum.SymbolSfx, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocTransType() (v enum.AllocTransType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRefAllocID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAvgPxPrecision() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTradeDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPositionEffect() (v enum.PositionEffect, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetIssuer() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityDesc() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetNetMoney() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetNumDaysInterest() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAccruedInterestRate() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAccruedInterestAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityType() (v enum.SecurityType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocLinkID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocLinkType() (v enum.AllocLinkType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMaturityMonthYear() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPutOrCall() (v enum.PutOrCall, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStrikePrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetOptAttribute() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityExchange() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSpread() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkCurveCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkCurveName() (v enum.BenchmarkCurveName, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkCurvePoint() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCouponRate() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCouponPaymentDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetIssueDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRepurchaseTerm() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRepurchaseRate() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFactor() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTradeOriginationDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetContractMultiplier() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYieldType() (v enum.YieldType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYield() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTotalTakedown() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetConcession() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRepoCollateralSecurityType() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRedemptionDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCreditRating() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTradingSessionID() (v enum.TradingSessionID, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedIssuerLen() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedIssuer() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedSecurityDescLen() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedSecurityDesc() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEncodedText() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetGrossTradeAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPriceType() (v enum.PriceType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMultiLegReportingType() (v enum.MultiLegReportingType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetProduct() (v enum.Product, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCFICode() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBookingRefID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCountryOfIssue() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStateOrProvinceOfIssue() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetLocaleOfIssue() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTotalAccruedInterestAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMaturityDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetInstrRegistry() (v enum.InstrRegistry, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPreviouslyReported() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMatchType() (v enum.MatchType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTradeInputSource() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCustOrderCapacity() (v enum.CustOrderCapacity, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTradingSessionSubID() (v enum.TradingSessionSubID, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocType() (v enum.AllocType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetLegalConfirm() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkPriceType() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetContractSettlMonth() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetDeliveryForm() (v enum.DeliveryForm, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPool() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYieldRedemptionDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYieldRedemptionPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYieldRedemptionPriceType() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkSecurityID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetReversalIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetYieldCalcDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetClearingBusinessDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetInterestAtMaturity() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAutoAcceptIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBenchmarkSecurityIDSource() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecuritySubType() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetBookingType() (v enum.BookingType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTerminationType() (v enum.TerminationType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecondaryAllocID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocCancReplaceReason() (v enum.AllocCancReplaceReason, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocIntermedReqType() (v enum.AllocIntermedReqType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAvgPxIndicator() (v enum.AvgPxIndicator, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTrdType() (v enum.TrdType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTrdSubType() (v enum.TrdSubType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetQtyType() (v enum.QtyType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAllocNoOrdersType() (v enum.AllocNoOrdersType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAvgParPx() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPctAtRisk() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetDatedDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetInterestAccrualDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCPProgram() (v enum.CPProgram, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCPRegType() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTotNoAllocs() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetLastFragment() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMarginRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAgreementDesc() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAgreementID() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAgreementDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStartDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEndDate() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetAgreementCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetDeliveryType() (v enum.DeliveryType, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEndAccruedInterestAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStartCash() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetEndCash() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStrikeCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityStatus() (v enum.SecurityStatus, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSettleOnOpenFlag() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStrikeMultiplier() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetStrikeValue() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMinPriceIncrement() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPositionLimit() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetNTPositionLimit() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetRndPx() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetUnitOfMeasure() (v enum.UnitOfMeasure, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetTimeUnit() (v enum.TimeUnit, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMessageEventSource() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetInstrmtAssignmentMethod() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMaturityTime() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetMinPriceIncrementAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityGroup() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityXMLLen() (v int, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityXML() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSecurityXMLSchema() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPriceUnitOfMeasure() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPriceUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetSettlMethod() (v enum.SettlMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetExerciseStyle() (v enum.ExerciseStyle, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetPriceQuoteMethod() (v enum.PriceQuoteMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetListMethod() (v enum.ListMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetCapPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFloorPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetProductComplex() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFlexProductEligibilityIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFlexibleIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m AllocationInstructionAlert) HasPutOrCall() bool {
...
func (m AllocationInstructionAlert) HasMinPriceIncrementAmount() bool {
	return m.Has(tag.MinPriceIncrementAmount)
}

//HasUnitOfMeasureQty returns true if UnitOfMeasureQty is present, Tag 1147
func (m AllocationInstructionAlert) HasUnitOfMeasureQty() bool {
	return m.Has(tag.UnitOfMeasureQty)
}

//HasSecurityGroup returns true if SecurityGroup is present, Tag 1151
func (m AllocationInstructionAlert) HasSecurityGroup() bool {
	return m.Has(tag.SecurityGroup)
}

//HasSecurityXMLLen returns true if SecurityXMLLen is present, Tag 1184
func (m AllocationInstructionAlert) HasSecurityXMLLen() bool {
	return m.Has(tag.SecurityXMLLen)
}

//HasSecurityXML returns true if SecurityXML is present, Tag 1185
func (m AllocationInstructionAlert) HasSecurityXML() bool {
	return m.Has(tag.SecurityXML)
}

//HasSecurityXMLSchema returns true if SecurityXMLSchema is present, Tag 1186
func (m AllocationInstructionAlert) HasSecurityXMLSchema() bool {
	return m.Has(tag.SecurityXMLSchema)
}

//HasPriceUnitOfMeasure returns true if PriceUnitOfMeasure is present, Tag 1191
func (m AllocationInstructionAlert) HasPriceUnitOfMeasure() bool {
	return m.Has(tag.PriceUnitOfMeasure)
}

//HasPriceUnitOfMeasureQty returns true if PriceUnitOfMeasureQty is present, Tag 1192
func (m AllocationInstructionAlert) HasPriceUnitOfMeasureQty() bool {
	return m.Has(tag.PriceUnitOfMeasureQty)
}

//HasSettlMethod returns true if SettlMethod is present, Tag 1193
func (m AllocationInstructionAlert) HasSettlMethod() bool {
	return m.Has(tag.SettlMethod)
}

//HasExerciseStyle returns true if ExerciseStyle is present, Tag 1194
func (m AllocationInstructionAlert) HasExerciseStyle() bool {
	return m.Has(tag.ExerciseStyle)
}

//HasOptPayAmount returns true if OptPayAmount is present, Tag 1195
func (m AllocationInstructionAlert) HasOptPayAmount() bool {
	return m.Has(tag.OptPayAmount)
}

//HasPriceQuoteMethod returns true if PriceQuoteMethod is present, Tag 1196
func (m AllocationInstructionAlert) HasPriceQuoteMethod() bool {
	return m.Has(tag.PriceQuoteMethod)
}

//HasFuturesValuationMethod returns true if FuturesValuationMethod is present, Tag 1197
func (m AllocationInstructionAlert) HasFuturesValuationMethod() bool {
	return m.Has(tag.FuturesValuationMethod)
}

//HasListMethod returns true if ListMethod is present, Tag 1198
func (m AllocationInstructionAlert) HasListMethod() bool {
	return m.Has(tag.ListMethod)
}

//HasCapPrice returns true if CapPrice is present, Tag 1199
func (m AllocationInstructionAlert) HasCapPrice() bool {
	return m.Has(tag.CapPrice)
}

//HasFloorPrice returns true if FloorPrice is present, Tag 1200
func (m AllocationInstructionAlert) HasFloorPrice() bool {
	return m.Has(tag.FloorPrice)
}

//HasProductComplex returns true if ProductComplex is present, Tag 1227
func (m AllocationInstructionAlert) HasProductComplex() bool {
	return m.Has(tag.ProductComplex)
}

//HasFlexProductEligibilityIndicator returns true if FlexProductEligibilityIndicator is present, Tag 1242
func (m AllocationInstructionAlert) HasFlexProductEligibilityIndicator() bool {
	return m.Has(tag.FlexProductEligibilityIndicator)
}

//HasFlexibleIndicator returns true if FlexibleIndicator is present, Tag 1244
func (m AllocationInstructionAlert) HasFlexibleIndicator() bool {
...
func (m NoExecs) GetTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m NoExecs) GetFirmTradeID() (v string, err quickfix.MessageRejectError) {

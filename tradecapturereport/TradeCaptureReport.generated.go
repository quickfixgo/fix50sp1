...
func New(lastqty field.LastQtyField, lastpx field.LastPxField) (m TradeCaptureReport) {
...
func (m TradeCaptureReport) SetCurrency(v string) {
...
func (m TradeCaptureReport) SetSettlCurrency(v string) {
...
func (m TradeCaptureReport) SetPutOrCall(v enum.PutOrCall) {
...
func (m TradeCaptureReport) SetSettlSessID(v enum.SettlSessID) {
...
func (m TradeCaptureReport) SetShortSaleReason(v enum.ShortSaleReason) {
...
func (m TradeCaptureReport) SetTrdRptStatus(v enum.TrdRptStatus) {
...
func (m TradeCaptureReport) SetSecurityStatus(v enum.SecurityStatus) {
...
func (m TradeCaptureReport) SetUnderlyingSettlementDate(v string) {
	m.Set(field.NewUnderlyingSettlementDate(v))
}
...
func (m TradeCaptureReport) SetUnitOfMeasure(v enum.UnitOfMeasure) {
	m.Set(field.NewUnitOfMeasure(v))
}

//SetTimeUnit sets TimeUnit, Tag 997
func (m TradeCaptureReport) SetTimeUnit(v enum.TimeUnit) {
...
func (m TradeCaptureReport) SetAsOfIndicator(v enum.AsOfIndicator) {
...
func (m TradeCaptureReport) SetOrderCategory(v enum.OrderCategory) {
...
func (m TradeCaptureReport) SetTradeHandlingInstr(v enum.TradeHandlingInstr) {
...
func (m TradeCaptureReport) SetTZTransactTime(v string) {
	m.Set(field.NewTZTransactTime(v))
}

//SetReportedPxDiff sets ReportedPxDiff, Tag 1134
func (m TradeCaptureReport) SetReportedPxDiff(v bool) {
	m.Set(field.NewReportedPxDiff(v))
}

//SetMinPriceIncrementAmount sets MinPriceIncrementAmount, Tag 1146
func (m TradeCaptureReport) SetMinPriceIncrementAmount(value decimal.Decimal, scale int32) {
	m.Set(field.NewMinPriceIncrementAmount(value, scale))
}

//SetUnitOfMeasureQty sets UnitOfMeasureQty, Tag 1147
func (m TradeCaptureReport) SetUnitOfMeasureQty(value decimal.Decimal, scale int32) {
	m.Set(field.NewUnitOfMeasureQty(value, scale))
}

//SetSecurityGroup sets SecurityGroup, Tag 1151
func (m TradeCaptureReport) SetSecurityGroup(v string) {
	m.Set(field.NewSecurityGroup(v))
}

//SetApplID sets ApplID, Tag 1180
func (m TradeCaptureReport) SetApplID(v string) {
	m.Set(field.NewApplID(v))
}

//SetApplSeqNum sets ApplSeqNum, Tag 1181
func (m TradeCaptureReport) SetApplSeqNum(v int) {
	m.Set(field.NewApplSeqNum(v))
}

//SetSecurityXMLLen sets SecurityXMLLen, Tag 1184
func (m TradeCaptureReport) SetSecurityXMLLen(v int) {
	m.Set(field.NewSecurityXMLLen(v))
}

//SetSecurityXML sets SecurityXML, Tag 1185
func (m TradeCaptureReport) SetSecurityXML(v string) {
	m.Set(field.NewSecurityXML(v))
}

//SetSecurityXMLSchema sets SecurityXMLSchema, Tag 1186
func (m TradeCaptureReport) SetSecurityXMLSchema(v string) {
	m.Set(field.NewSecurityXMLSchema(v))
}

//SetVolatility sets Volatility, Tag 1188
func (m TradeCaptureReport) SetVolatility(value decimal.Decimal, scale int32) {
	m.Set(field.NewVolatility(value, scale))
}

//SetRiskFreeRate sets RiskFreeRate, Tag 1190
func (m TradeCaptureReport) SetRiskFreeRate(value decimal.Decimal, scale int32) {
	m.Set(field.NewRiskFreeRate(value, scale))
}

//SetPriceUnitOfMeasure sets PriceUnitOfMeasure, Tag 1191
func (m TradeCaptureReport) SetPriceUnitOfMeasure(v string) {
	m.Set(field.NewPriceUnitOfMeasure(v))
}

//SetPriceUnitOfMeasureQty sets PriceUnitOfMeasureQty, Tag 1192
func (m TradeCaptureReport) SetPriceUnitOfMeasureQty(value decimal.Decimal, scale int32) {
	m.Set(field.NewPriceUnitOfMeasureQty(value, scale))
}

//SetSettlMethod sets SettlMethod, Tag 1193
func (m TradeCaptureReport) SetSettlMethod(v enum.SettlMethod) {
	m.Set(field.NewSettlMethod(v))
}

//SetExerciseStyle sets ExerciseStyle, Tag 1194
func (m TradeCaptureReport) SetExerciseStyle(v enum.ExerciseStyle) {
	m.Set(field.NewExerciseStyle(v))
}

//SetOptPayAmount sets OptPayAmount, Tag 1195
func (m TradeCaptureReport) SetOptPayAmount(value decimal.Decimal, scale int32) {
	m.Set(field.NewOptPayAmount(value, scale))
}

//SetPriceQuoteMethod sets PriceQuoteMethod, Tag 1196
func (m TradeCaptureReport) SetPriceQuoteMethod(v enum.PriceQuoteMethod) {
	m.Set(field.NewPriceQuoteMethod(v))
}

//SetFuturesValuationMethod sets FuturesValuationMethod, Tag 1197
func (m TradeCaptureReport) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
	m.Set(field.NewFuturesValuationMethod(v))
}

//SetListMethod sets ListMethod, Tag 1198
func (m TradeCaptureReport) SetListMethod(v enum.ListMethod) {
	m.Set(field.NewListMethod(v))
}

//SetCapPrice sets CapPrice, Tag 1199
func (m TradeCaptureReport) SetCapPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewCapPrice(value, scale))
}

//SetFloorPrice sets FloorPrice, Tag 1200
func (m TradeCaptureReport) SetFloorPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewFloorPrice(value, scale))
}

//SetProductComplex sets ProductComplex, Tag 1227
func (m TradeCaptureReport) SetProductComplex(v string) {
	m.Set(field.NewProductComplex(v))
}

//SetFlexProductEligibilityIndicator sets FlexProductEligibilityIndicator, Tag 1242
func (m TradeCaptureReport) SetFlexProductEligibilityIndicator(v bool) {
	m.Set(field.NewFlexProductEligibilityIndicator(v))
}

//SetFlexibleIndicator sets FlexibleIndicator, Tag 1244
func (m TradeCaptureReport) SetFlexibleIndicator(v bool) {
	m.Set(field.NewFlexibleIndicator(v))
}

//SetRejectText sets RejectText, Tag 1328
func (m TradeCaptureReport) SetRejectText(v string) {
	m.Set(field.NewRejectText(v))
}

//SetFeeMultiplier sets FeeMultiplier, Tag 1329
func (m TradeCaptureReport) SetFeeMultiplier(value decimal.Decimal, scale int32) {
	m.Set(field.NewFeeMultiplier(value, scale))
}

//SetApplLastSeqNum sets ApplLastSeqNum, Tag 1350
func (m TradeCaptureReport) SetApplLastSeqNum(v int) {
	m.Set(field.NewApplLastSeqNum(v))
}

//SetApplResendFlag sets ApplResendFlag, Tag 1352
func (m TradeCaptureReport) SetApplResendFlag(v bool) {
	m.Set(field.NewApplResendFlag(v))
}

//SetDividendYield sets DividendYield, Tag 1380
func (m TradeCaptureReport) SetDividendYield(value decimal.Decimal, scale int32) {
	m.Set(field.NewDividendYield(value, scale))
}

//SetCurrencyRatio sets CurrencyRatio, Tag 1382
func (m TradeCaptureReport) SetCurrencyRatio(value decimal.Decimal, scale int32) {
	m.Set(field.NewCurrencyRatio(value, scale))
}

//SetNoTrdRepIndicators sets NoTrdRepIndicators, Tag 1387
func (m TradeCaptureReport) SetNoTrdRepIndicators(f NoTrdRepIndicatorsRepeatingGroup) {
	m.SetGroup(f)
}

//SetTradePublishIndicator sets TradePublishIndicator, Tag 1390
func (m TradeCaptureReport) SetTradePublishIndicator(v enum.TradePublishIndicator) {
...
func (m TradeCaptureReport) GetCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSettlCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPutOrCall() (v enum.PutOrCall, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetGrossTradeAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSettlSessID() (v enum.SettlSessID, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSettlSessSubID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetLastUpdateTime() (v time.Time, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetCopyMsgIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPublishTrdIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetShortSaleReason() (v enum.ShortSaleReason, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTrdRptStatus() (v enum.TrdRptStatus, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecurityStatus() (v enum.SecurityStatus, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSettleOnOpenFlag() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetStrikeMultiplier() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetStrikeValue() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetMinPriceIncrement() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPositionLimit() (v int, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetNTPositionLimit() (v int, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetUnderlyingSettlementDate() (v string, err quickfix.MessageRejectError) {
	var f field.UnderlyingSettlementDateField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m TradeCaptureReport) GetRndPx() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTierCode() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetUnitOfMeasure() (v enum.UnitOfMeasure, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTimeUnit() (v enum.TimeUnit, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetMessageEventSource() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetAsOfIndicator() (v enum.AsOfIndicator, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetNoInstrumentParties() (NoInstrumentPartiesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecondaryTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFirmTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecondaryFirmTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetInstrmtAssignmentMethod() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetCalculatedCcyLastQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetLastSwapPoints() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetMaturityTime() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOrderCategory() (v enum.OrderCategory, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetNoRootPartyIDs() (NoRootPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTradeHandlingInstr() (v enum.TradeHandlingInstr, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOrigTradeHandlingInstr() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOrigTradeDate() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOrigTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOrigSecondaryTradeID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTZTransactTime() (v string, err quickfix.MessageRejectError) {
	var f field.TZTransactTimeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m TradeCaptureReport) GetReportedPxDiff() (v bool, err quickfix.MessageRejectError) {
	var f field.ReportedPxDiffField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m TradeCaptureReport) GetMinPriceIncrementAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecurityGroup() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetApplID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetApplSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecurityXMLLen() (v int, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecurityXML() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSecurityXMLSchema() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetVolatility() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetRiskFreeRate() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPriceUnitOfMeasure() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPriceUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSettlMethod() (v enum.SettlMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetExerciseStyle() (v enum.ExerciseStyle, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetPriceQuoteMethod() (v enum.PriceQuoteMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetListMethod() (v enum.ListMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetCapPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFloorPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetProductComplex() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFlexProductEligibilityIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFlexibleIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetRejectText() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFeeMultiplier() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetApplLastSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetApplResendFlag() (v bool, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetDividendYield() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
//GetCurrencyRatio gets CurrencyRatio, Tag 1382
func (m TradeCaptureReport) GetCurrencyRatio() (v decimal.Decimal, err quickfix.MessageRejectError) {
	var f field.CurrencyRatioField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m TradeCaptureReport) GetNoTrdRepIndicators() (NoTrdRepIndicatorsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetTradePublishIndicator() (v enum.TradePublishIndicator, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) HasCurrency() bool {
...
func (m TradeCaptureReport) HasSettlCurrency() bool {
...
func (m TradeCaptureReport) HasPutOrCall() bool {
...
func (m TradeCaptureReport) HasUnderlyingSettlementDate() bool {
	return m.Has(tag.UnderlyingSettlementDate)
}
...
func (m NoSides) SetExchangeSpecialInstructions(v string) {
	m.Set(field.NewExchangeSpecialInstructions(v))
}
...
func (m NoSides) GetExecRefID() (v string, err quickfix.MessageRejectError) {
...
func (m NoSides) GetExchangeSpecialInstructions() (v string, err quickfix.MessageRejectError) {
	var f field.ExchangeSpecialInstructionsField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m NoSides) HasExchangeSpecialInstructions() bool {
	return m.Has(tag.ExchangeSpecialInstructions)
}

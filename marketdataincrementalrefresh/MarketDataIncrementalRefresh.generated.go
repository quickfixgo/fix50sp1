...
func (m NoMDEntries) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m NoMDEntries) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m NoMDEntries) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoMDEntries) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m NoMDEntries) HasOptPayAmount() bool {
...
func (m NoMDEntries) HasFuturesValuationMethod() bool {

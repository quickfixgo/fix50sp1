...
func (m CollateralInquiry) SetPutOrCall(v enum.PutOrCall) {
...
func (m CollateralInquiry) SetSettlMethod(v enum.SettlMethod) {
	m.Set(field.NewSettlMethod(v))
}

//SetExerciseStyle sets ExerciseStyle, Tag 1194
func (m CollateralInquiry) SetExerciseStyle(v enum.ExerciseStyle) {
	m.Set(field.NewExerciseStyle(v))
}

//SetOptPayAmount sets OptPayAmount, Tag 1195
func (m CollateralInquiry) SetOptPayAmount(value decimal.Decimal, scale int32) {
	m.Set(field.NewOptPayAmount(value, scale))
}

//SetPriceQuoteMethod sets PriceQuoteMethod, Tag 1196
func (m CollateralInquiry) SetPriceQuoteMethod(v enum.PriceQuoteMethod) {
	m.Set(field.NewPriceQuoteMethod(v))
}

//SetFuturesValuationMethod sets FuturesValuationMethod, Tag 1197
func (m CollateralInquiry) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
	m.Set(field.NewFuturesValuationMethod(v))
}

//SetListMethod sets ListMethod, Tag 1198
func (m CollateralInquiry) SetListMethod(v enum.ListMethod) {
...
func (m CollateralInquiry) GetPutOrCall() (v enum.PutOrCall, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetMinPriceIncrementAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSecurityGroup() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSecurityXMLLen() (v int, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSecurityXML() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSecurityXMLSchema() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetPriceUnitOfMeasure() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetPriceUnitOfMeasureQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSettlMethod() (v enum.SettlMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetExerciseStyle() (v enum.ExerciseStyle, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetPriceQuoteMethod() (v enum.PriceQuoteMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetListMethod() (v enum.ListMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetCapPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetFloorPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetProductComplex() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetFlexProductEligibilityIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetFlexibleIndicator() (v bool, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) HasOptPayAmount() bool {
...
func (m CollateralInquiry) HasFuturesValuationMethod() bool {

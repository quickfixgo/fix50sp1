...
func (m MarketDataRequest) SetApplQueueMax(v int) {
	m.Set(field.NewApplQueueMax(v))
}

//SetApplQueueAction sets ApplQueueAction, Tag 815
func (m MarketDataRequest) SetApplQueueAction(v enum.ApplQueueAction) {
	m.Set(field.NewApplQueueAction(v))
}

//SetMDQuoteType sets MDQuoteType, Tag 1070
func (m MarketDataRequest) SetMDQuoteType(v enum.MDQuoteType) {
...
func (m MarketDataRequest) GetApplQueueMax() (v int, err quickfix.MessageRejectError) {
...
func (m MarketDataRequest) GetApplQueueAction() (v enum.ApplQueueAction, err quickfix.MessageRejectError) {
...
func (m MarketDataRequest) GetMDQuoteType() (v enum.MDQuoteType, err quickfix.MessageRejectError) {
...
func (m NoRelatedSym) SetMDEntrySize(value decimal.Decimal, scale int32) {
...
func (m NoRelatedSym) GetMDEntrySize() (v decimal.Decimal, err quickfix.MessageRejectError) {

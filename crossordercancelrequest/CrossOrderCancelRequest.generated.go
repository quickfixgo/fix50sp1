...
func (m CrossOrderCancelRequest) SetNoRootPartyIDs(f NoRootPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m CrossOrderCancelRequest) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m CrossOrderCancelRequest) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m CrossOrderCancelRequest) GetPutOrCall() (v enum.PutOrCall, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetSecurityStatus() (v enum.SecurityStatus, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetUnitOfMeasure() (v enum.UnitOfMeasure, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetTimeUnit() (v enum.TimeUnit, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetNoInstrumentParties() (NoInstrumentPartiesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetNoRootPartyIDs() (NoRootPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetSettlMethod() (v enum.SettlMethod, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetExerciseStyle() (v enum.ExerciseStyle, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetListMethod() (v enum.ListMethod, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetCapPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetFloorPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) HasOptPayAmount() bool {
...
func (m CrossOrderCancelRequest) HasFuturesValuationMethod() bool {

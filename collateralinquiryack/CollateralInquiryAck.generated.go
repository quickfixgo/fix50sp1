...
func (m CollateralInquiryAck) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m CollateralInquiryAck) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m CollateralInquiryAck) GetPutOrCall() (v enum.PutOrCall, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) GetTimeUnit() (v enum.TimeUnit, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) GetCapPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) HasOptPayAmount() bool {
...
func (m CollateralInquiryAck) HasFuturesValuationMethod() bool {

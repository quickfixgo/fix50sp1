...
func (m SecurityList) SetClearingBusinessDate(v string) {
...
func (m SecurityList) GetClearingBusinessDate() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetSecurityReportID() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetApplID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetApplSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetMarketSegmentID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetMarketID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetApplLastSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityList) GetApplResendFlag() (v bool, err quickfix.MessageRejectError) {
...
func (m SecurityList) HasClearingBusinessDate() bool {

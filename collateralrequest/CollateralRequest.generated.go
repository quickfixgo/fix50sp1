...
func (m CollateralRequest) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m CollateralRequest) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m CollateralRequest) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralRequest) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralRequest) HasOptPayAmount() bool {
...
func (m CollateralRequest) HasFuturesValuationMethod() bool {

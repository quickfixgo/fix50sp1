...
func (m CollateralAssignment) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m CollateralAssignment) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m CollateralAssignment) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralAssignment) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralAssignment) HasOptPayAmount() bool {
...
func (m CollateralAssignment) HasFuturesValuationMethod() bool {

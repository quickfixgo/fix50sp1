...
func (m Confirmation) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m Confirmation) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m Confirmation) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Confirmation) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m Confirmation) HasOptPayAmount() bool {
...
func (m Confirmation) HasFuturesValuationMethod() bool {

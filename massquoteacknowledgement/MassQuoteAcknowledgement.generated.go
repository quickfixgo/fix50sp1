...
func (m NoQuoteEntries) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m NoQuoteEntries) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoQuoteEntries) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {

...
func (m SecurityListRequest) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m SecurityListRequest) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m SecurityListRequest) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityListRequest) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityListRequest) HasOptPayAmount() bool {
...
func (m SecurityListRequest) HasFuturesValuationMethod() bool {

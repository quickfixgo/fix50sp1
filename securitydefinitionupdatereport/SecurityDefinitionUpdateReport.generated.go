...
func (m SecurityDefinitionUpdateReport) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m SecurityDefinitionUpdateReport) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m SecurityDefinitionUpdateReport) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinitionUpdateReport) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityDefinitionUpdateReport) HasOptPayAmount() bool {
...
func (m SecurityDefinitionUpdateReport) HasFuturesValuationMethod() bool {

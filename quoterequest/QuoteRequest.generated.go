...
func (m QuoteRequest) SetPreTradeAnonymity(v bool) {
	m.Set(field.NewPreTradeAnonymity(v))
}

//SetNoRootPartyIDs sets NoRootPartyIDs, Tag 1116
func (m QuoteRequest) SetNoRootPartyIDs(f NoRootPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}

//SetPrivateQuote sets PrivateQuote, Tag 1171
func (m QuoteRequest) SetPrivateQuote(v bool) {
	m.Set(field.NewPrivateQuote(v))
}

//SetRespondentType sets RespondentType, Tag 1172
func (m QuoteRequest) SetRespondentType(v enum.RespondentType) {
...
func (m QuoteRequest) GetPreTradeAnonymity() (v bool, err quickfix.MessageRejectError) {
...
func (m QuoteRequest) GetNoRootPartyIDs() (NoRootPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m QuoteRequest) GetPrivateQuote() (v bool, err quickfix.MessageRejectError) {
...
func (m QuoteRequest) GetRespondentType() (v enum.RespondentType, err quickfix.MessageRejectError) {

...
func (m OrderMassCancelRequest) SetOptPayAmount(value decimal.Decimal, scale int32) {
...
func (m OrderMassCancelRequest) SetFuturesValuationMethod(v enum.FuturesValuationMethod) {
...
func (m OrderMassCancelRequest) GetOptPayAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m OrderMassCancelRequest) GetFuturesValuationMethod() (v enum.FuturesValuationMethod, err quickfix.MessageRejectError) {
...
func (m OrderMassCancelRequest) HasOptPayAmount() bool {
...
func (m OrderMassCancelRequest) HasFuturesValuationMethod() bool {
